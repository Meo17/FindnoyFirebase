...
<main id="main" class="main">
    ...
    <nav>
        <ol class="breadcrumb">
<!--<li class="breadcrumb-item"><a href="{{url('dashboard_police_station')}}">Dashboard</a></li>-->
        <li class="breadcrumb-item"><a href="{{url('showall')}}">Notification</a></li>
        <li class="breadcrumb-item"><a href="{{url('extend_showalll')}}">Inbox</a></li>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                    ...
                                    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        <td class="content-block" style="text-align: center;font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0;" valign="top">
                                           &copy; Copyright FindNoy. All Rights Reserved
                                        </td>
                                    </tr>
                                </tbody></table>
                            </td>
...
<!-- End #main -->
<script src="{{asset('assets/js/Showall/extend_showall.js')}}"></script>
