    ...
    <div class="col-lg-12">
      <div class="row">
        ...
        <div class="col-xxl-4 col-md-4">
          <div class="card info-card sales-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Missing Person/s</h5>
        ...
        <div class="col-xxl-4 col-md-4">
          <div class="card info-card revenue-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Missing Vehicle/s</h5>
      ...
      <div class="col-xxl-4 col-md-4">
          <div class="card info-card sales-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Wanted Person/s</h5>
...
<script>
                document.addEventListener("DOMContentLoaded", () => {
                  new ApexCharts(document.querySelector("#reportsChart"), {
                    series: [{
                      name: 'Person/s',
                      data: <?php echo $miss_p_ar; ?>,
                    }, {
                      name: 'Vehicle/s',
                      data: <?php echo $carnapped_v_ar; ?>,
                    }, {
                      name: 'Wanted',
                      data: <?php echo $wanted_p_ar; ?>,
                    }],
                    chart: {
                      height: 350,
                      type: 'area',
