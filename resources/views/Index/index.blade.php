            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="{{url('/')}}" class=" d-flex align-items-center w-auto">
                  <img src="{{asset('assets/img/Name.png')}}" alt="" style="width:150px;height:150px">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small" style="color:red">{{!empty($mess)? $mess:""}}</p>
                  </div>
              ...
              <div class="credits">
                    <a href="https://bootstrapmade.com/">FindNoy 2022</a>
              </div>
