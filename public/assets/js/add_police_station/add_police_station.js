 $(document).ready(function () {
	...
	$("#select_prov option[value='0']").attr("disabled","disabled");
	$("#select_prov option[value='1']").attr("disabled","disabled");
	$("#select_prov option[value='2']").attr("disabled","disabled");
	$("#select_prov option[value='4']").attr("disabled","disabled");
	$("#select_prov option[value='5']").attr("disabled","disabled");
	$("#select_prov option[value='6']").attr("disabled","disabled");
	$("#select_prov option[value='7']").attr("disabled","disabled");
	$("#select_prov option[value='8']").attr("disabled","disabled");
	$("#select_prov option[value='9']").attr("disabled","disabled");
	$("#select_prov option[value='10']").attr("disabled","disabled");
	$("#select_prov option[value='11']").attr("disabled","disabled");
	$("#select_prov option[value='12']").attr("disabled","disabled");
	$("#select_prov option[value='13']").attr("disabled","disabled");
	$("#select_prov option[value='14']").attr("disabled","disabled");
	$("#select_prov option[value='15']").attr("disabled","disabled");
